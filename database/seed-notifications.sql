...
INSERT INTO notifications (
  ...
  '✓ GeoKollect - Account Verified',
  'Your account has been verified successfully. You can now log in and start using GeoKollect to collect waste data in your area.',
  'read',
  NOW() - INTERVAL '2 days',
  NOW() - INTERVAL '2 days',
  NOW() - INTERVAL '2 days',
...
INSERT INTO notifications (
  ...
  'A new version of GeoKollect is available. Update now to get new features and improvements!',
  'read',
  NOW() - INTERVAL '3 days',
  NOW() - INTERVAL '3 days',
  NOW() - INTERVAL '3 days',
...
INSERT INTO notifications (
  ...
  'account_verification',
  '✓ GeoKollect - Account Verified',
  'Your account has been verified successfully. You can now log in and start using GeoKollect.',
  'read',
  NOW() - INTERVAL '5 days',
  NOW() - INTERVAL '5 days',
  NOW() - INTERVAL '5 days',
