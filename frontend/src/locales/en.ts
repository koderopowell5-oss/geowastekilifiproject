...
export const en = {
  ...
  dashboardSubtitle: 'Data collection overview',
  ...
  recordsSubtitle: 'All waste site submissions',
  ...
  assignmentSubtitle: 'Manage enumerator work areas',
